...
"fun"			 => (append token_list "FUN" "fun"; colinc(columnNum, yytext); appendFile("FUN\n"); tokenNum := !tokenNum + 1; T.FUN((!lineNum, !columnNum - 3), (!lineNum, !columnNum - 3, !tokenNum - 1), (!lineNum, !columnNum - 3, !tokenNum - 1)));
"fn"			 => (append token_list "FN" "fn"; colinc(columnNum, yytext); appendFile("FN\n"); tokenNum := !tokenNum + 1; T.FN((!lineNum, !columnNum - 2), (!lineNum, !columnNum - 2, !tokenNum - 1), (!lineNum, !columnNum - 2, !tokenNum - 1)));
...
"if"			 => (append token_list "IF" "if"; colinc(columnNum, yytext); appendFile("IF\n"); tokenNum := !tokenNum + 1; T.IF((!lineNum, !columnNum - 2), (!lineNum, !columnNum - 2, !tokenNum - 1), (!lineNum, !columnNum - 2, !tokenNum - 1)));
...
"fi"			 => (append token_list "FI" "fi"; colinc(columnNum, yytext); appendFile("FI\n"); tokenNum := !tokenNum + 1; T.FI((!lineNum, !columnNum - 1), (!lineNum, !columnNum - 2, !tokenNum - 1), (!lineNum, !columnNum - 2, !tokenNum - 1)));
"let"			 => (append token_list "LET" "let"; colinc(columnNum, yytext); appendFile("LET\n"); tokenNum := !tokenNum + 1; T.LET((!lineNum, !columnNum - 3), (!lineNum, !columnNum - 3, !tokenNum - 1), (!lineNum, !columnNum - 3, !tokenNum - 1)));
...
"end"			 => (append token_list "END" "end"; colinc(columnNum, yytext); appendFile("END\n"); tokenNum := !tokenNum + 1; T.END((!lineNum, !columnNum - 1), (!lineNum, !columnNum - 3, !tokenNum - 1), (!lineNum, !columnNum - 3, !tokenNum - 1)));
"TRUE" | "FALSE" => (append token_list "CONST_Bool" yytext; colinc(columnNum, yytext); appendFile("CONST_Bool\n"); tokenNum := !tokenNum + 1; T.CONST_Bool((Bvalue(yytext), ((!lineNum, !columnNum - String.size(yytext)), (!lineNum, !columnNum - 1))), (!lineNum, !columnNum - String.size(yytext), !tokenNum - 1), (!lineNum, !columnNum - String.size(yytext), !tokenNum - 1)));
{number}+		 => (append token_list "CONST_Int" yytext; colinc(columnNum, yytext); appendFile("CONST_Int\n"); tokenNum := !tokenNum + 1; T.CONST_Int((Nvalue(yytext), ((!lineNum, !columnNum - String.size(yytext)), (!lineNum, !columnNum - 1))), (!lineNum, !columnNum - String.size(yytext), !tokenNum - 1), (!lineNum, !columnNum - String.size(yytext), !tokenNum - 1)));
{alpha}({number} | {alpha})* => (append token_list "ID" yytext; colinc(columnNum, yytext); appendFile("ID\n"); tokenNum := !tokenNum + 1; T.ID((yytext, ((!lineNum, !columnNum - String.size(yytext)), (!lineNum, !columnNum - 1))), (!lineNum, !columnNum - String.size(yytext), !tokenNum - 1), (!lineNum, !columnNum - String.size(yytext), !tokenNum - 1)));
