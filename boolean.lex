...
"PLUS"			 => (append token_list "PLUS" "PLUS"; colinc(columnNum, yytext); appendFile("PLUS\n"); tokenNum := !tokenNum + 1; T.PLUS((!lineNum, !columnNum - 4, !tokenNum - 1), (!lineNum, !columnNum - 4, !tokenNum - 1)));
"MINUS"			 => (append token_list "MINUS" "MINUS"; colinc(columnNum, yytext); appendFile("MINUS\n"); tokenNum := !tokenNum + 1; T.MINUS((!lineNum, !columnNum - 5, !tokenNum - 1), (!lineNum, !columnNum - 5, !tokenNum - 1)));
"TIMES"			 => (append token_list "TIMES" "TIMES"; colinc(columnNum, yytext); appendFile("TIMES\n"); tokenNum := !tokenNum + 1; T.TIMES((!lineNum, !columnNum - 5, !tokenNum - 1), (!lineNum, !columnNum - 5, !tokenNum - 1)));
"NEGATE"		 => (append token_list "NEGATE" "NEGATE"; colinc(columnNum, yytext); appendFile("NEGATE\n"); tokenNum := !tokenNum + 1; T.NEGATE((!lineNum, !columnNum - 6, !tokenNum - 1), (!lineNum, !columnNum - 6, !tokenNum - 1)));
"LESSTHAN"		 => (append token_list "LESSTHAN" "LESSTHAN"; colinc(columnNum, yytext); appendFile("LESSTHAN\n"); tokenNum := !tokenNum + 1; T.LESSTHAN((!lineNum, !columnNum - 8, !tokenNum - 1), (!lineNum, !columnNum - 8, !tokenNum - 1)));
"GREATERTHAN"	 => (append token_list "GREATERTHAN" "GREATERTHAN"; colinc(columnNum, yytext); appendFile("GREATERTHAN\n"); tokenNum := !tokenNum + 1; T.GREATERTHAN((!lineNum, !columnNum - 11, !tokenNum - 1), (!lineNum, !columnNum - 11, !tokenNum - 1)));
...
{alpha}+{number}* => (append token_list "ID" yytext; colinc(columnNum, yytext); appendFile("ID\n"); tokenNum := !tokenNum + 1; T.ID(yytext, (!lineNum, !columnNum - String.size(yytext), !tokenNum - 1), (!lineNum, !columnNum - String.size(yytext), !tokenNum - 1)));
{number}+{alpha}+ => (error(!lineNum, !columnNum, yytext); colinc(columnNum, yytext); lex());
